      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center mb-4">
            <span class="text-2xl font-bold text-blue-400">UniAppli</span>
          </div>
          <p class="text-gray-300 mb-4 max-w-md">
            Votre partenaire de confiance pour tous vos besoins en développement d'applications. 
            Nous créons des solutions innovantes et sur mesure.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink to="/" class="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                Accueil
              </NuxtLink>
            </li>
            <li>
        ...
        <div>
          ...
          <div class="space-y-2 text-gray-300">
            <div class="flex items-center">
              ...
              <span class="text-sm">128 rue des papillons, 40230 Benesse-Maremne. France</span>
            </div>
            <div class="flex items-center">
              <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center">
              ...
              <span class="text-sm">07 81 39 94 46</span>
            </div>
          </div>
        </div>
      </div>
