  ...
  <div class="relative min-h-[70vh] bg-gray-50 px-4 py-20">
    ...
    <div class="mx-auto max-w-3xl text-center">
      <div class="inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-1 text-emerald-700">
        ...
        <span class="text-sm font-medium">✅ Message Envoyé !</span>
      </div>

      <h1 class="mt-6 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Nous avons bien reçu votre message !</h1>
      <!-- Lottie centered -->
      ...
      <p class="mt-4 text-lg text-gray-700">
        Nous vous remercions pour votre message et nous vous contactons dans les plus brefs délais.
      </p>
      <div class="mt-10">
...
useHead({
  ...
  meta: [
    ...
    { name: 'description', content: "Message envoyé · Nous revenons vers vous très rapidement." }
  ]
})
</script>
