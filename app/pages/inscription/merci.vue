  ...
  <div class="relative min-h-[70vh] bg-gray-50 px-4 py-20">
    ...
    <div class="mx-auto max-w-3xl text-center">
      <div class="inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-1 text-emerald-700">
        ...
        <span class="text-sm font-medium">✅ Inscription confirmée !</span>
      </div>

      <h1 class="mt-6 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Et c'est parti !</h1>
      <!-- Lottie centered -->
      ...
      <p class="mt-4 text-lg text-gray-700">
        Nous mettons tout en œuvre pour vous livrer, au plus vite, la solution <span class="font-bold text-primary-gradient drop-shadow-md text-4xl font-lobster">UniAppli</span> qui va booster votre activité.
      </p>
      <p class="mt-2 text-gray-600">
        Nous sommes ravis de travailler avec vous et impatients de vous aider à atteindre vos objectifs.
      </p>
